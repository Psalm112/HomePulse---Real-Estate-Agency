  ...
  return (
    <>
      <div className="flex flex-row">
        ...
        <div className="w-full h-screen bg-[url('./assets/onboarding.jpg')] bg-cover bg-no-repeat bg-[30%_50%] md:bg-none">
          <div className="my-[auto] h-full flex flex-col items-center justify-center gap-y-5 bg-black/[0.8] md:bg-[rgba(3,_7,_24,_0.8)]">
